...
/**
 * Created by ¬ероника on 12.12.2015.
 */
public class PlayActivity extends Activity {
    ...
    private static final int ALL_STREAMS=8;//максимальное кол-во одновременно воспроизводимых файлов
...
//один раз загружает этот звук в пам€ть и оттуда его воспроизводит
        SoundPool soundPoll= new SoundPool(ALL_STREAMS, AudioManager.STREAM_MUSIC, 0);
                                                        //тип аудио-потока..0 - качество кодировани€ уже не юзаетс€
